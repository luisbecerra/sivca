...
class Excel extends \PHPExcel
{
     ...
     *  Pass an array to the sheet to fill it with
     *
     *  @param array $array The 2d array to fill the sheet with
     *  @return $this
     *
     */

    public function with2dArray( $source = array(), $nullValue = NULL, $startCell = 'A1', $strictNullComparison = false ) 
    {
        ...
        foreach( $source as $row ) {
            $this->excel->getActiveSheet()->fromArray($row,NULL,$startCol.$rowNumber++);
        }
